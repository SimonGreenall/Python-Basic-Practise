...
class NeutralNetwork():
    ...
    # def backward_propagation_with_regularization(self, X, Y, cache, parameters,lambd):    
    #             #正则化反向传播
    #         m = X.shape[1] #输入样本数量
    #         A1=cache["A1"]
    #         A2=cache["A2"]
    ...
    def train(self,X,Y,epoch,lambd,learning_rate, losses2):
...
if __name__ == "__main__":
    ...
    for learning_rate in learning_rates:
        ...
        lab_nn.train(x, y, 10, 1, learning_rate, losses)
        losses_all.append(losses)
    i = 0
    for loss in losses_all:
        i += 1
        plt.plot(loss,color='blue',label='loss vs iteration')
